...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $promasud['favicon_logo_uploaded']['url']; ?>" type="image/x-icon">
  ...
  <body <?php body_class(); ?>>
    ...
    <header id="topnav">
      <div class="container">
        ...
        <div class="logo">
          <a href="index-2.html">
            <img src="<?php echo $promasud['logo_uploaded']['url']; ?>" alt="" class="logo-light">
            <img src="<?php echo $promasud['pal_logo_uploaded']['url']; ?>" alt="" class="logo-dark">
                ...
                <ul class="nav product-list">
                  <li>
                    <div class="product-thumbnail">
                      <img src="<?php echo get_template_directory_uri(); ?>/acess/images//shop/2.jpg" alt="">
                    </div>
                  ...
                  <li>
                    <div class="product-thumbnail">
                      <img src="<?php echo get_template_directory_uri(); ?>/acess/images//shop/5.jpg" alt="">
                    </div>
                    <div class="product-summary">
        ...
        <?php wp_nav_menu([
        	'theme_location'			=> 'mine-menu',
        	'container_class'			=> ' ',
        	'container_id'				=> 'navigation',
        	'menu_class'			  	=> 'navigation-menu',
        	'menu_id'					    => ' ',
        	'fallback_cb'			   	=> 'amader_menu',

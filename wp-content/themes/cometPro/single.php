          ...
          <div class="v-center">
            <div class="container">
              <div class="title center">
                ...
                <h4><?php the_time('F d, Y | g:i:a') ?></h4>
                <hr>
              </div>
            </div>
            <!-- end of container-->
          ...
          <div class="col-md-8">
            ...
            <article class="post-single">
              ...
              <div class="post-media">
              		...
              		<?php if(get_post_meta( get_the_ID(), 'iaal', true)): ?>
			          	<div class="media-audio">
			         		 <audio controls src="<?php echo get_post_meta( get_the_ID(), 'iaal', true); ?>"></audio>
			        	</div>

              		<?php elseif(get_post_meta( get_the_ID(), 'iavl', true)): ?>

              			<div class="media-video">
			              	<video controls src="<?php echo  get_post_meta( get_the_id(), 'iavl', true); ?>"></video>
			            </div>

              		<?php elseif(get_post_meta( get_the_ID(), 'saig', true)): ?>
            ...
            <div id="comments">
              ...
              <ul class="comments-list">
                <li>
                  <div class="comment">
                    <div class="comment-pic">
                      <img src="<?php echo get_template_directory_uri(); ?>/acess/images/team/1.jpg" alt="" class="img-circle">
                    </div>
                  ...
                  <ul class="children">
                    <li>
                      <div class="comment">
                        <div class="comment-pic">
                          <img src="<?php echo get_template_directory_uri(); ?>/acess/images/team/2.jpg" alt="" class="img-circle">
                        </div>
                        <div class="comment-text">
                ...
                <li>
                  <div class="comment">
                    <div class="comment-pic">
                      <img src="<?php echo get_template_directory_uri(); ?>/acess/images/team/3.jpg" alt="" class="img-circle">
                    </div>
                    <div class="comment-text">
